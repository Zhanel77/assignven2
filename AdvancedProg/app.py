...
st.title("Embedded Chat with Llama3.2")
menu = st.radio("Choose an action", ["Add Data", "Show Data", "Chat Bot"])

if menu == "Add Data":
    st.subheader("Add Data to the Bot")
    input_text = st.text_area("Enter data")
        ...
        if user_input.strip():
            ...
            if relevant_docs:
                ...
                if similarity_score <= relevance_threshold:
                    st.write("Answers from the database:")
